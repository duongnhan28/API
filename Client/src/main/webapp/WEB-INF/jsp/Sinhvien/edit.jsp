                    ...
                    <div class="col-md-10 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form:form class="forms-sample" action="/sinhvien/edit" method="post" modelAttribute="editSinhVien">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <form:input class="form-control" type="text" path="ngaysinh"/>
...
<%--                                    <form:label path="malop" class="col-2 col-form-label">Lớp</form:label>--%>
                                    <div class="col-10">
                                        <form:select path="lop">
                                            <form:options items="${lop}" itemLabel="tenlop" itemValue="malop"/>
                                        </form:select>
