                    ...
                    <div class="col-md-10 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form:form class="forms-sample" method="post" action="/lop/add" modelAttribute="addLopForm">
                                    <div class="form-group">
                                        <label>Tenkhoa</label>
                                        <div class="input-group">
                                            <form:input class="form-control" type="text" path="tenLop"/>
                                            <form:errors path="tenLop"/>
                                        </div>
                                        <label>SISO</label>
                                        <div class="input-group">
                                            <form:input class="form-control" type="text" path="siSo"/>
                                            <form:errors path="siSo"/>
                                        </div>
                                        <label>Khoa</label>
                                        <div class="form-group row">
<%--                                            <form:label path="khoa">Category</form:label>--%>
                                            <div class="col-10">
                                                <form:select path="khoa.id">
                                                    <form:options items="${khoa}" itemLabel="tenKhoa" itemValue="id"/>
                                                </form:select>
